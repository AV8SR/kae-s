...
module.exports = {
  ...
  async execute(message, client, args) {
    ...
    const ssuvoteEmbed = new EmbedBuilder()
      .setColor(0xf3c443)
      .setDescription(
        `# <:AV8SRC:1352864587460120627> Race Vote! <:AV8SRC:1352864587460120627>\nHello AV8SR fans, we all know you've been waiting for an epic race, vote below to get a race kickstarted! Make sure you have your pit crew ready and set for this race as well!\n\nVotes Required: **${maxVotes}**`
      )
      .setImage(
        "https://media.discordapp.net/attachments/1180956991775064069/1353852109988167833/Screenshot202025-03-2420at207.png?ex=67e32888&is=67e1d708&hm=7f9addea1a625773271162fabaa3e59c0220e51c819235efa3f65bc5d5e19f41&=&format=webp&quality=lossless&width=2400&height=384"
      );
      const ssuvoteEmbed1 = new EmbedBuilder()
      .setColor(0xf3c443)
      .setImage(
        "https://media.discordapp.net/attachments/1180956991775064069/1353852189231153253/Screenshot202025-03-2420at207.png?ex=67e3289b&is=67e1d71b&hm=6e15726361f1ad2d0214d172e7e1b204eb887f7b28d47845e9d2ec94667b4647&=&format=webp&quality=lossless&width=2412&height=576"
      );
