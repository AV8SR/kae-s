...
module.exports = {
  ...
  async execute(message, client, args) {
    ...
    async function fetchData() {
      let server = null, queueCount = 0, staffCount = 0, ownerName = "Unknown";
    ...
    async function createEmbed(data, lastUpdate) {
      ...
      return new EmbedBuilder()
        ...
        .setImage(
          "https://media.discordapp.net/attachments/1180956991775064069/1353861365798011021/Screenshot202025-03-2420at2011.png?ex=67e33127&is=67e1dfa7&hm=1bcf70c01d20f3ac0ea577d6c3877c8e29bb946d256ed88a91bd9a7361031094&=&format=webp&quality=lossless&width=2384&height=348"
        )
        .setColor(0x9bc557);
    }
    ...
    try {
      ...
      .setColor(0x9bc557)
      .setImage(`https://media.discordapp.net/attachments/1180956991775064069/1353861298978553856/Screenshot202025-03-2420at2011.png?ex=67e33117&is=67e1df97&hm=e150fc968443c5f22f5dd5dae2421c15351a737afcc4b287ee676eef03cff112&=&format=webp&quality=lossless&width=2388&height=544`);
      ...
      const voterMentions = Array.from(global.voters).map(id => `<@${id}>`).join(',');
      ...
      async function updateEmbed() {
        try {
          ...
          const updatedAdditionalEmbed = new EmbedBuilder()
          .setColor(0x9bc557)
          .setImage(`https://media.discordapp.net/attachments/1180956991775064069/1353861298978553856/Screenshot202025-03-2420at2011.png?ex=67e33117&is=67e1df97&hm=e150fc968443c5f22f5dd5dae2421c15351a737afcc4b287ee676eef03cff112&=&format=webp&quality=lossless&width=2388&height=544`);
